...
const sidebarItems: Array<{ title: string; items: SidebarNavItem[] }> = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Temples", href: "/temples", icon: <Sparkles /> },
      { title: "Festivals", href: "/festivals", icon: <Flower2 /> },
      { title: "Deities", href: "/deities", icon: <Sparkles /> },
      { title: "Panchang", href: "/panchang", icon: <CalendarDays /> },
...
function Breadcrumbs() {
  ...
  return <AppBreadcrumb homeHref="/dashboard" items={items.length ? items : [{ label: "Dashboard" }]} />;
}
