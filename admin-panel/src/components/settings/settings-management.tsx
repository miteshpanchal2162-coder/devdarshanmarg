...
const sections: Array<{ label: string; value: SettingsSection; href: string; icon: React.ReactNode }> = [
  { label: "General Settings", value: "general", href: "/settings", icon: <Settings /> },
  { label: "Site Settings", value: "site", href: "/settings/site", icon: <Palette /> },
  { label: "SEO Settings", value: "seo", href: "/settings/seo", icon: <SearchCheck /> },
  { label: "Localization", value: "localization", href: "/settings/localization", icon: <Globe2 /> },
  { label: "Supported Languages", value: "languages", href: "/settings/languages", icon: <Languages /> },
  { label: "Media Types", value: "media-types", href: "/settings/media-types", icon: <ImageIcon /> },
  { label: "Content Types", value: "content-types", href: "/settings/content-types", icon: <Type /> },
  { label: "Notification Settings", value: "notifications", href: "/settings/notifications", icon: <Bell /> },
  { label: "Email Settings", value: "email", href: "/settings/email", icon: <Mail /> },
  { label: "Security Settings", value: "security", href: "/settings/security", icon: <LockKeyhole /> },
  { label: "Backup & Maintenance", value: "backup-maintenance", href: "/settings/backup-maintenance", icon: <DatabaseBackup /> },
  { label: "About System", value: "about", href: "/settings/about", icon: <Info /> },
];
